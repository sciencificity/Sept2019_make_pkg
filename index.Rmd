...
author: "Vebash Naidoo (@Sciencificity)"
...
1. Run Travis for continuous integration - it runs the checks and your tests, when new commits are made. `usethis::use_travis()` [Your package has to be public to use the free version of Travis, which if using a GitHub public repo is `r emo::ji("check")`].
